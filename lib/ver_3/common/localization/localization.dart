...
import 'package:qlutter/ver_3/common/localization/generated/l10n.dart' as generated show GeneratedLocalization, AppLocalizationDelegate;
...
final class _LocalizationView extends LocalizationsDelegate<Localization> {
  ...
  @override
  Future<Localization> load(Locale locale) => generated.GeneratedLocalization.load(locale).then<Localization>((localization) => Localization._current = Localization._(locale));
