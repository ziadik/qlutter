...
import 'package:qlutter/ver_3/common/localization/generated/intl/messages_all.dart';
...
class GeneratedLocalization {
  ...
  static GeneratedLocalization get current {
    assert(_current != null, 'No instance of GeneratedLocalization was loaded. Try to initialize the GeneratedLocalization delegate before accessing GeneratedLocalization.current.');
    return _current!;
  }
  ...
  static GeneratedLocalization of(BuildContext context) {
    ...
    assert(instance != null, 'No instance of GeneratedLocalization present in the widget tree. Did you add GeneratedLocalization.delegate in localizationsDelegates?');
    return instance!;
  }
  ...
  String get localeCode {
    return Intl.message('en_US', name: 'localeCode', desc: 'Locale code', args: []);
  }

  /// `en`
  String get languageCode {
    return Intl.message('en', name: 'languageCode', desc: 'Language code', args: []);
  }

  /// `English`
  String get language {
    return Intl.message('English', name: 'language', desc: 'Language', args: []);
  }

  /// `Color Pool Puzzle`
  String get title {
    return Intl.message('Color Pool Puzzle', name: 'title', desc: '', args: []);
  }
  ...
  /// `Starred`
  String get starred {
    return Intl.message('Starred', name: 'starred', desc: '', args: []);
  }
  ...
  String get anUnknownErrorWasReceivedFromTheServer {
    return Intl.message('An unknown error was received from the server', name: 'anUnknownErrorWasReceivedFromTheServer', desc: '', args: []);
  }
  ...
  String get copyButton {
    return Intl.message('Copy', name: 'copyButton', desc: '', args: []);
  }
  ...
  String get renameButton {
    return Intl.message('Rename', name: 'renameButton', desc: '', args: []);
  }

  /// `Upload`
  String get uploadButton {
    return Intl.message('Upload', name: 'uploadButton', desc: '', args: []);
  }

  /// `Download`
  String get downloadButton {
    return Intl.message('Download', name: 'downloadButton', desc: '', args: []);
  }

  /// `Share`
  String get shareButton {
    return Intl.message('Share', name: 'shareButton', desc: '', args: []);
  }
  ...
  String get restoreButton {
    return Intl.message('Restore', name: 'restoreButton', desc: '', args: []);
  }

  /// `Profile`
  String get profileButton {
    return Intl.message('Profile', name: 'profileButton', desc: '', args: []);
  }
  ...
  String get apiDomain {
    return Intl.message('API domain', name: 'apiDomain', desc: '', args: []);
  }

  /// `No plan`
  String get noPlan {
    return Intl.message('No plan', name: 'noPlan', desc: '', args: []);
  }
